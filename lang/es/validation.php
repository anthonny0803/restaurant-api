...
return [
    ...
    'attributes'             => [
        'cancellation_deadline_hours' => 'horas límite para cancelar',
        'category'                 => 'categoría',
        'closing_time'             => 'hora de cierre',
        'daily_stock'              => 'stock diario',
        'date_from'                => 'fecha desde',
        'date_to'                  => 'fecha hasta',
        'default_reservation_duration_minutes' => 'duración de la reserva en minutos',
        'deposit_per_person'       => 'depósito por persona',
        'featured'                 => 'destacado',
        ...
        'refund_percentage'        => 'porcentaje de reembolso',
        'reminder_hours_before'    => 'horas de antelación del recordatorio',
        'seats_requested'          => 'comensales',
        'start_time'               => 'hora de inicio',
        'table_id'                 => 'mesa',
        'time_slot_interval_minutes' => 'intervalo entre franjas en minutos',
        'token'                    => 'token',
        'address'                  => 'dirección',
